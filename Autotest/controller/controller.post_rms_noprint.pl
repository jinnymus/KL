...
#print "rec_id = ".$rec_id."<br>\n";
#print "rec_type = ".$rec_type."<br>\n";
#print "verdict_name = ".$verdict_name."<br>\n";
...
sub post
{
	...
	$verdict_encode = MIME::Base64::encode($verdict_name);
	...
	$xml=$xml."<rec_id>".$rec_id."</rec_id>";
	$xml=$xml."<rec_type>".$rec_type."</rec_type>";
	$xml=$xml."<rec_revision>".$rec_revision."</rec_revision>";
