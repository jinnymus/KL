...
. ../testcase.Change_config.content_limit.time/case.sh
...
run_change_config $1 'testcase.Change_config.content_limit.time' 'ipm.conf' 'content_output_limit' '1000' 'case.sh' $fail
}
